...
export default {
  ...
  computed: {
    ...
    msgUnreadCount () {
      return this.$store.state.user.messageUnreadCount
    },
    groupUnreadCount () {
      return this.$store.state.user.groupUnreadCount
    },
    perUnreadCount () {
      return this.$store.state.user.perUnreadCount
    }
  },
  methods: {
    ...mapMutations([
    ...
    ...mapActions([
      ...
      'getUnreadGroupNoticeCount',
      'getUnreadPerNoticeCount'
    ]),
    turnToPage (route) {
